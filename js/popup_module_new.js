...
app.controller('popup_controller', function($scope,$rootScope, $http, $timeout, $location, $filter, $sce, tasAlert, tasService){
    ...
    $scope.cl_bk_edit_company = function(res){
       if (res['message'] == 'done'){
	  $scope.cmp_info	= res
          console.log('res::::::::::::::', $scope.cmp_info)
